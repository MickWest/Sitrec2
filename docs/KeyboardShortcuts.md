...
| `G` | Go To: prompts for a frame number (jumps there and pauses), a date and/or time (`12pm`, `15:20`, `17:33 UTC`, `12/25`, `Jan 6, 2020`), a coordinate in any format, or a place name to fly the camera to. Pasting text onto Sitrec (Ctrl/Cmd+V outside a text field) runs it through the same parser |
