...
// The release's site. Named SITE rather than OCEAN since the benchmark
// moved onto land — an over-water origin gave every scene nothing to look
// at when opened.
...
export const SCENARIOS = [
    {
        ...
        spec: {epochISO: EPOCH, durationSeconds: 60, fps: FPS,
            initialHorizontalRangeM: 5000, siteId: SITE,
    ...
    },
    {
        ...
        spec: {epochISO: EPOCH, durationSeconds: 15, fps: FPS,
            initialHorizontalRangeM: 20000, siteId: SITE,
            platform: ORBIT,
    ...
    },
    {
        ...
        scenarioSeed: 106,
        spec: {epochISO: EPOCH, durationSeconds: 60, fps: FPS,
            initialHorizontalRangeM: 2000, siteId: SITE,
    ...
    },
    {
        ...
        scenarioSeed: 108,
        spec: {epochISO: EPOCH, durationSeconds: 60, fps: FPS,
            initialHorizontalRangeM: 50000, siteId: SITE,
