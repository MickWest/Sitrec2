...
export default defineConfig({
  ...
  testMatch: ['**/ui-playwright.test.js', '**/ui-menu-sweep.test.js', '**/save-load-roundtrip.test.js', '**/chatbot-playwright.test.js', '**/webm-video-export.test.js', '**/motion-analysis.test.js', '**/motion-accumulation.test.js', '**/video-loading.test.js', '**/satellite-label-visibility.test.js', '**/mobile-viewport.test.js', '**/video-cache-gaps.test.js', '**/nitf-decode.test.js'],
