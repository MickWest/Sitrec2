...
export const PARAMETER_GROUPS = [
    {name: "Airframe", open: true, fields: [
        choice("bodyStyle", "Basic type", {transport: "Transport / airliner", light: "Light aircraft", jet: "Streamlined jet", glider: "Glider"}, "transport"),
        number("length", "Fuselage length · m", 3, 85, 0.01, 39.5),
        number("diameter", "Fuselage width · m", 0.4, 9, 0.01, 3.8),
        number("bodyHeight", "Height / width", 0.6, 1.6, 0.01, 1.04),
    ...
    {name: "Cockpit glazing", note: "Move Position left to slide the glazing forward. All changes preview live.", fields: [
        ...
        choice("cockpitStyle", "Glazing style", {auto: "Automatic", airliner: "Airliner · six panes", airliner4: "Airliner · four panes", windshield: "Crown windshield panes", canopy: "Bubble canopy"}, "auto"),
    ...
    {name: "Wings", open: true, fields: [
        ...
        choice("wingPlanform", "Planform", {taper: "Straight taper", cranked: "Cranked trailing edge"}, "taper"),
    ...
    {name: "Tail & canards", fields: [
        choice("tailStyle", "Tail layout", {conventional: "Conventional", t: "T-tail", v: "V-tail", twin: "Twin fin", none: "No horizontal tail"}, "conventional"),
    ...
    {name: "Engines & propellers", fields: [
        ...
        choice("engineCount", "Engine count", {1: "1", 2: "2", 3: "3", 4: "4"}, 2),
        choice("engineMount", "Mounting", {wing: "Under wing", rear: "Rear fuselage", nose: "Nose"}, "wing"),
        ...
        number("propDiameter", "Propeller diameter · m", 0.7, 6, 0.01, 2),
    ...
    {name: "Livery & details", fields: [
        ...
        number("windowEnd", "Cabin ends · % from nose", 55, 92, 0.1, 72.5),
        ...
        choice("gearStyle", "Landing gear", {tricycle: "Tricycle", taildragger: "Taildragger"}, "tricycle"),
...
export function usesAirlinerWindscreen(p) {
    return ["airliner", "airliner4"].includes(p.cockpitStyle) || ((p.cockpitStyle === undefined || p.cockpitStyle === "auto") &&
...
const fighter = {bodyStyle: "jet", length: 15, diameter: 1.5, noseLength: 29, tailLength: 28, span: 10,
    ...
    engineMount: "rear", engineCount: 1, engineDiameter: 1.2, engineLength: 3.2, windowCount: 0,
...
export const PRESETS = [
    ...
    preset("concorde", "Concorde-style · supersonic delta", "Special configurations", {...fighter, length: 61.7, diameter: 2.9, noseLength: 30, span: 25.6, rootChord: 24, taper: 0.08, sweep: 62, wingPosition: 47, tailStyle: "none", finHeight: 6.5, finChord: 8, engineMount: "wing", engineCount: 4, engineDiameter: 1.6, engineLength: 6, windowCount: 48, bodyColor: "#f1f4f8", wingColor: "#e1e7ed", livery: "stripe", accentColor: "#234a87"}),
];
