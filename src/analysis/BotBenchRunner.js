...
const DIAGNOSTIC_FAMILY_KEYS = new Set([...SWEEP_VARIANTS.map((v) => v.key), "gfKalman", ...MONTE_CARLO_IDS]);
...
export async function runBotBenchAnalysis(record, {
    ...
    const manifest = Object.freeze({
        ...
        optimizers: {
            ...
            lanternCorrectedWind: battery.lanternCorrectedWind?.params?.optimizer ?? null,
