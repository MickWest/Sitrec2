...
import {fitConstantAcceleration, buildLOSDataset, unpackFitPositions, assessLinearFitConditioning} from "../LOSFitting";
...
export class CNodeLOSFitCA extends CNodeTrack {
    ...
    _doCompute() {
        ...
        this._fitDiagTitle = "Constant Acceleration Fit Diagnostics";
