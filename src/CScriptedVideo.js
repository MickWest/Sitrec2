...
class CScriptedVideoManager {
    ...
    // scale the per-source-frame tangent by this, so a frozen shot has zero velocity and
    // a reversed one points backwards along the track (the follow/ride lead, for example).
    sitFrameRateAt(t) {
