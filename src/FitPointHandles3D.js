...
// The pure geometry — surfaceAlongRay and groundUnderCanvasPoint — lives in
...
import {surfaceAlongRay, groundUnderCanvasPoint} from "./FitSurfacePick";
export {surfaceAlongRay, groundUnderCanvasPoint};
